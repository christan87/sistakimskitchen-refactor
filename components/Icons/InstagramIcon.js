...
export default function InstgramIcon({width, height, color, className}) {
    return(
        <svg fill={`${color}`} width={`${width}px`} height={`${height}px`} viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" class={`${styles[`${className}`]} jam jam-instagram`}>
